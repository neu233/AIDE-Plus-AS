...
public class SAXMessageFormatter {
    ...
    public static String formatMessage(Locale locale,
        ...
        if (locale != null) {
            resourceBundle =
                SecuritySupport.getResourceBundle("jaxp.sun.org.apache.xerces.internal.impl.msg.SAXMessages", locale);
        }
        else {
            resourceBundle =
                SecuritySupport.getResourceBundle("jaxp.sun.org.apache.xerces.internal.impl.msg.SAXMessages");
        }
