...
class RegexParser {
    ...
    public void setLocale(Locale locale) {
        try {
            if (locale != null) {
                this.resources = SecuritySupport.getResourceBundle("jaxp.sun.org.apache.xerces.internal.impl.xpath.regex.message", locale);
            }
            else {
                this.resources = SecuritySupport.getResourceBundle("jaxp.sun.org.apache.xerces.internal.impl.xpath.regex.message");
            }
        }
