...
import jaxp.sun.org.apache.xerces.internal.parsers.DOMParserImpl;
import jaxp.sun.org.apache.xerces.internal.parsers.DTDConfiguration;
...
import jaxp.sun.org.apache.xml.internal.serialize.DOMSerializerImpl;
            ...
            if ((feature.equalsIgnoreCase("+XPath"))
                ...
                try {
                    Class xpathClass = ObjectFactory.findProviderClass(
                        "jaxp.sun.org.apache.xpath.internal.domapi.XPathEvaluatorImpl", true);
        ...
        if (schemaType == XMLGrammarDescription.XML_SCHEMA) {
            ...
            if(freeValidatorIndex < 0) {
                return (RevalidationHandler) (ObjectFactory
                            .newInstance(
                                "jaxp.sun.org.apache.xerces.internal.impl.xs.XMLSchemaValidator",
            ...
            if(freeDTDValidatorIndex < 0) {
                return (RevalidationHandler) (ObjectFactory
                            .newInstance(
                                "jaxp.sun.org.apache.xerces.internal.impl.dtd.XMLDTDValidator",
                                ObjectFactory.findClassLoader(),
                                true));
            }
            // return first available validator
