     ...
     */
     public String formatMessage(Locale locale, String key, Object[] arguments)
        ...
        if (fResourceBundle == null || locale != fLocale) {
            if (locale != null) {
                fResourceBundle = SecuritySupport.getResourceBundle("jaxp.sun.org.apache.xerces.internal.impl.msg.XMLSchemaMessages", locale);
                // memorize the most-recent locale
                fLocale = locale;
            }
            if (fResourceBundle == null)
                fResourceBundle = SecuritySupport.getResourceBundle("jaxp.sun.org.apache.xerces.internal.impl.msg.XMLSchemaMessages");
        }
        ...
        if (msg == null) {
            ...
            throw new MissingResourceException(msg, "jaxp.sun.org.apache.xerces.internal.impl.msg.SchemaMessages", key);
        }
