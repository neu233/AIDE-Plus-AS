...
import jaxp.sun.org.apache.xalan.internal.lib.ExsltCommon;
...
import jaxp.sun.org.apache.xml.internal.dtm.ref.DTMNodeList;
...
import jaxp.sun.org.apache.xpath.internal.ExpressionNode;
...
public class XRTreeFrag extends XObject implements Cloneable
{
  ...
  public Object object()
  {
    if (m_DTMXRTreeFrag.getXPathContext() != null)
      return new DTMNodeIterator((DTMIterator)(new NodeSetDTM(m_dtmRoot, m_DTMXRTreeFrag.getXPathContext().getDTMManager())));
    else
      return super.object();
  }
