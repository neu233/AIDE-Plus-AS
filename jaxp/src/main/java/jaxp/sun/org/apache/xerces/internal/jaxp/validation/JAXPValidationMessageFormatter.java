...
final class JAXPValidationMessageFormatter {
    ...
    public static String formatMessage(Locale locale,
        ...
        if (locale != null) {
            resourceBundle =
                SecuritySupport.getResourceBundle("jaxp.sun.org.apache.xerces.internal.impl.msg.JAXPValidationMessages", locale);
        }
        else {
            resourceBundle =
                SecuritySupport.getResourceBundle("jaxp.sun.org.apache.xerces.internal.impl.msg.JAXPValidationMessages");
        }
