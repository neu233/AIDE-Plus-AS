...
public final class XMLLimitAnalyzer {
    ...
    public XMLLimitAnalyzer() {
        values = new int[XMLSecurityManager.Limit.values().length];
        totalValue = new int[XMLSecurityManager.Limit.values().length];
        names = new String[XMLSecurityManager.Limit.values().length];
        caches = new Map[XMLSecurityManager.Limit.values().length];
    }
    ...
    public void addValue(int index, String entityName, int value) {
        if (index == XMLSecurityManager.Limit.ENTITY_EXPANSION_LIMIT.ordinal() ||
                index == XMLSecurityManager.Limit.MAX_OCCUR_NODE_LIMIT.ordinal() ||
                index == XMLSecurityManager.Limit.ELEMENT_ATTRIBUTE_LIMIT.ordinal()) {
        ...
        if (index == XMLSecurityManager.Limit.GENERAL_ENTITY_SIZE_LIMIT.ordinal() ||
                index == XMLSecurityManager.Limit.PARAMETER_ENTITY_SIZE_LIMIT.ordinal()) {
            totalValue[XMLSecurityManager.Limit.TOTAL_ENTITY_SIZE_LIMIT.ordinal()] += value;
        }
    }
