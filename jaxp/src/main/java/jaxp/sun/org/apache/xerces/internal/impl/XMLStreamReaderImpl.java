...
import jaxp.sun.xml.internal.stream.StaxErrorReporter;
import jaxp.sun.xml.internal.stream.XMLEntityStorage;
import jaxp.sun.xml.internal.stream.events.EntityDeclarationImpl;
import jaxp.sun.xml.internal.stream.events.NotationDeclarationImpl;
...
import jaxp.sun.org.apache.xerces.internal.util.NamespaceContextWrapper;
import jaxp.sun.org.apache.xerces.internal.util.SymbolTable;
import jaxp.sun.xml.internal.stream.dtd.nonvalidating.XMLNotationDecl;
import jaxp.sun.xml.internal.stream.dtd.nonvalidating.DTDGrammar;
...
public class XMLStreamReaderImpl implements XMLStreamReader {
    ...
    */
    ...
    private void switchToXML11Scanner() throws IOException{
        ...
        jaxp.sun.org.apache.xerces.internal.xni.NamespaceContext oldNamespaceContext = fScanner.fNamespaceContext;
     ...
     * @return
     */
    public QName convertXNIQNametoJavaxQName(jaxp.sun.org.apache.xerces.internal.xni.QName qname){
