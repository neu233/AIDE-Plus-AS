...
import jaxp.xml.stream.XMLOutputFactory;
...
import jaxp.sun.org.apache.xerces.internal.impl.PropertyManager;

import jaxp.sun.xml.internal.stream.writers.XMLDOMWriterImpl;
import jaxp.sun.xml.internal.stream.writers.XMLEventWriterImpl;
import jaxp.sun.xml.internal.stream.writers.XMLStreamWriterImpl;
...
public class XMLOutputFactoryImpl extends XMLOutputFactory {
    ...
    public XMLEventWriter createXMLEventWriter(java.io.OutputStream outputStream) throws XMLStreamException {
        return createXMLEventWriter(outputStream,  null);
    }

    public XMLEventWriter createXMLEventWriter(java.io.OutputStream outputStream, String encoding) throws XMLStreamException {
    ...
    public XMLStreamWriter createXMLStreamWriter(java.io.OutputStream outputStream) throws XMLStreamException {
        return createXMLStreamWriter(outputStream, null);
    }

    public XMLStreamWriter createXMLStreamWriter(java.io.OutputStream outputStream, String encoding) throws XMLStreamException {
