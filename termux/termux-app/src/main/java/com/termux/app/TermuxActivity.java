...
public /*final*/ class TermuxActivity extends Activity implements ServiceConnection {
    ...
    public static void updateTermuxActivityStyling(Context context) {
        ...
        Intent stylingIntent = new Intent(TERMUX_ACTIVITY.ACTION_RELOAD_STYLE).setPackage(/* TODO: provide the application ID. For example: */ ContextUtil.getContext().getPackageName());
