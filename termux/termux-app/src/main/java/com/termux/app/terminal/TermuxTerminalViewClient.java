...
public class TermuxTerminalViewClient extends TermuxTerminalViewClientBase {
    ...
    public void reportIssueFromTranscript() {
        ...
        if (transcriptText == null)
            return;
        MessageDialogUtils.showMessage(mActivity, TermuxConstants.TERMUX_APP_NAME + " Report Issue", mActivity.getString(R.string.msg_add_termux_debug_info), mActivity.getString(com.termux.shared.R.string.action_yes), new OnClickListener() {

            @Override
            public void onClick(DialogInterface dialog, int which) {
                reportIssueFromTranscript(transcriptText, true);
            }
        }, mActivity.getString(com.termux.shared.R.string.action_no), new OnClickListener() {
