...
import com.termux.shared.window.Version.Companion.parse
...
internal class SidecarCompat @VisibleForTesting constructor(
    ...
    private var extensionCallback: ExtensionInterfaceCompat.ExtensionCallbackInterface? = null
    ...
    override fun setExtensionCallback(extensionCallback: ExtensionInterfaceCompat.ExtensionCallbackInterface) {
    ...
    override fun validateExtensionInterface(): Boolean {
        return try {
            ...
            val methodSetSidecarCallback = sidecar?.javaClass?.getMethod(
                "setSidecarCallback",
                SidecarInterface.SidecarCallback::class.java
            )
    ...
    internal inner class TranslatingCallback : SidecarInterface.SidecarCallback {
    ...
    private class DistinctElementCallback(
        private val callbackInterface: ExtensionInterfaceCompat.ExtensionCallbackInterface
    ...
    private class DistinctSidecarElementCallback(
        private val sidecarAdapter: SidecarAdapter,
        private val callbackInterface: SidecarInterface.SidecarCallback
    ) : SidecarInterface.SidecarCallback {
        private val lock = ReentrantLock()
