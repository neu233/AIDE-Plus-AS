...
public class MarkdownUtils {
     ...
     */
    public static Markwon getRecyclerMarkwonBuilder(final Context context) {
        return Markwon.builder(context).usePlugin(LinkifyPlugin.create(Linkify.EMAIL_ADDRESSES | Linkify.WEB_URLS)).usePlugin(new AbstractMarkwonPlugin() {
            ...
            public void configureVisitor(@NonNull MarkwonVisitor.Builder builder) {
                builder.on(FencedCodeBlock.class, new NodeVisitor<FencedCodeBlock>() {
                    ...
                    @Override
                    public void visit(MarkwonVisitor visitor, FencedCodeBlock fencedCodeBlock) {
                        // NB the `trim` operation on literal (as code will have a new line at the end)
     ...
     */
    public static Markwon getSpannedMarkwonBuilder(final Context context) {
        return Markwon.builder(context).usePlugin(StrikethroughPlugin.create()).usePlugin(new AbstractMarkwonPlugin() {
            ...
            public void configureSpansFactory(@NonNull MarkwonSpansFactory.Builder builder) {
                ...
                }).setFactory(BlockQuote.class, new SpanFactory() {

                    @Override
                    public Object getSpans(MarkwonConfiguration configuration, RenderProps props) {
                        return new QuoteSpan();
                    }
                }).setFactory(Strikethrough.class, new SpanFactory() {
                ...
                setFactory(ListItem.class, new SpanFactory() {
