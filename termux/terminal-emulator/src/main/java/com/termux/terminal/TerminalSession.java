    ...
    public void initializeEmulator(int columns, int rows) {
        ...
        new Thread("TermSessionInputReader[pid=" + mShellPid + "]") {
            ...
            public void run() {
                ...
                try {
					//读取子进程输出
                    termIn = new FileInputStream(terminalFileDescriptorWrapped);
        ...
        new Thread("TermSessionOutputWriter[pid=" + mShellPid + "]") {
			...
			public String getTerminalSessionTranscriptText(boolean linesJoined) {
				if (mEmulator == null)
					return null;
				TerminalBuffer terminalBuffer = mEmulator.getScreen();
				if (terminalBuffer == null)
					return null;
				String transcriptText = terminalBuffer.getSelectedText(
					0,
					terminalBuffer.getActiveTranscriptRows(),
					terminalBuffer.mColumns, 
					terminalBuffer.mScreenRows);
