...
public class ReflectPie {
	...
	public static boolean reflectAll() {
		if (initialized) {
			return IsReflectPie;
		}
		initialized = true;
     ...
     */
    @Deprecated
    public static ReflectPie on(String name) throws ReflectPieException {
        return onClass(name);
    }
     ...
     */
    @Deprecated
    public static ReflectPie on(String name, ClassLoader classLoader) throws ReflectPieException {
     ...
     */
    @Deprecated
    public static ReflectPie on(Class<?> clazz) {
     ...
     * @see #onClass(Class)
     */
    public static ReflectPie onClass(String name) throws ReflectPieException {
     ...
     * @see #onClass(Class)
     */
    public static ReflectPie onClass(String name, ClassLoader classLoader) throws ReflectPieException {
     ...
     * @return A wrapped class object, to be used for further reflection.
     */
    public static ReflectPie onClass(Class<?> clazz) {
        return new ReflectPie(clazz);
    }
     ...
     */
    public static ReflectPie on(Object object) {
        return new ReflectPie(object == null ? Object.class : object.getClass(), object);
    }

    private static ReflectPie on(Class<?> type, Object object) {
        return new ReflectPie(type, object);
    }
    ...
    private ReflectPie(Class<?> type) {
        this(type, type);
    }

    private ReflectPie(Class<?> type, Object object) {
        this.type = type;
        this.object = object;
    }
     ...
     * @throws ReflectException If any reflection exception occurred.
     */
    public ReflectPie set(String name, Object value) throws ReflectPieException {
        try {
            ...
            throw new ReflectPieException(e);
        }
    }
     ...
     * @see #field(String)
     */
    public <T> T get(String name) throws ReflectPieException {
     ...
     * @throws ReflectException If any reflection exception occurred.
     */
    public ReflectPie field(String name) throws ReflectPieException {
        try {
            Field field = field0(name);
    ...
    private Field field0(String name) throws ReflectPieException {
        Class<?> t = type();
     ...
     */
    public Map<String, ReflectPie> fields() {
        Map<String, ReflectPie> result = new LinkedHashMap<String, ReflectPie>();
        Class<?> t = type();
    ...
    public ReflectPie call(String name, Object... args) throws ReflectPieException {
        ...
        try {
            ...
            try {
                ...
                throw new ReflectPieException(e1);
            }
        }
    }
     ...
     * @see #create(Object...)
     */
    public ReflectPie create() throws ReflectPieException {
     ...
     * @throws ReflectException If any reflection exception occurred.
     */
    public ReflectPie create(Object... args) throws ReflectPieException {
        Class<?>[] types = types(args);
    ...
    public boolean equals(Object obj) {
        if (obj instanceof ReflectPie) {
            return object.equals(((ReflectPie) obj).get());
        }
     ...
     */
    private static ReflectPie on(Constructor<?> constructor, Object... args) throws ReflectPieException {
        try {
     ...
     */
    private static ReflectPie on(Method method, Object object, Object... args) throws ReflectPieException {
        try {
            accessible(method);
    ...
    private static Object unwrap(Object object) {
        if (object instanceof ReflectPie) {
            return ((ReflectPie) object).get();
        }
     ...
     */
    private static Class<?> forName(String name) throws ReflectPieException {
        try {
    ...
    private static Class<?> forName(String name, ClassLoader classLoader) throws ReflectPieException {
        try {
