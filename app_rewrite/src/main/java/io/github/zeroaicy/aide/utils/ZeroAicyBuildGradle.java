...
public class ZeroAicyBuildGradle extends BuildGradle {
	...
	public class ZeroAicyProductFlavor extends ProductFlavor {
		public final List<Dependency> productFlavorDependencies = new ArrayList<>();
	}
		...
		switch ( attributeName ) {
			...
			case "dependencies":
				...
				if ( productFlavor instanceof ZeroAicyProductFlavor ) {
					List<Dependency> productFlavorDependencies = ( (ZeroAicyProductFlavor)productFlavor ).productFlavorDependencies;
	...
	public List<Dependency> getFlavorDependencies(String productFlavorName ) {
