...
import jaxp.sun.org.apache.bcel.internal.generic.FLOAD;
import jaxp.sun.org.apache.bcel.internal.generic.FSTORE;
...
import jaxp.sun.org.apache.bcel.internal.generic.IfInstruction;
import jaxp.sun.org.apache.bcel.internal.generic.ILOAD;
import jaxp.sun.org.apache.bcel.internal.generic.IndexedInstruction;
...
import jaxp.sun.org.apache.bcel.internal.generic.InstructionTargeter;
...
import jaxp.sun.org.apache.bcel.internal.generic.LLOAD;
import jaxp.sun.org.apache.bcel.internal.generic.LSTORE;
...
import jaxp.sun.org.apache.bcel.internal.generic.TargetLostException;
import jaxp.sun.org.apache.bcel.internal.generic.Type;

import jaxp.sun.org.apache.xalan.internal.xsltc.compiler.Pattern;
...
public class MethodGenerator extends MethodGen
    implements jaxp.sun.org.apache.xalan.internal.xsltc.compiler.Constants {
    ...
    public MethodGenerator(int access_flags, jaxp.sun.org.apache.bcel.internal.generic.Type return_type,
                           jaxp.sun.org.apache.bcel.internal.generic.Type[] arg_types, String[] arg_names,
     ...
     */
    public LocalVariableGen addLocalVariable(String name, jaxp.sun.org.apache.bcel.internal.generic.Type type,
    ...
    public LocalVariableGen addLocalVariable2(String name, jaxp.sun.org.apache.bcel.internal.generic.Type type,
                                              InstructionHandle start)
    {
     ...
     * <p>The
     * {@link MethodGen#addLocalVariable(String, jaxp.sun.org.apache.bcel.internal.generic.Type,InstructionHandle,InstructionHandle)}</code>
     * and
     * {@link MethodGen#addLocalVariable(String, jaxp.sun.org.apache.bcel.internal.generic.Type,int,InstructionHandle,InstructionHandle)}</code>
    ...
    private Method outline(InstructionHandle first, InstructionHandle last,
        ...
        final jaxp.sun.org.apache.bcel.internal.generic.Type[] argTypes =
            new jaxp.sun.org.apache.bcel.internal.generic.Type[] {(new ObjectType(argTypeName)).toJCType()};
                ...
                if (c instanceof LocalVariableInstruction
                    ...
                    if (localVarMap.get(oldLVG) == null) {
                        ...
                        if (copyInLocalValue || copyOutLocalValue) {
                            ...
                            jaxp.sun.org.apache.bcel.internal.generic.Type varType = oldLVG.getType();
     ...
     * {@link LoadInstruction} based on the specified {@link jaxp.sun.org.apache.bcel.internal.generic.Type} that will
     * load the specified local variable
     * @param index the JVM stack frame index of the variable that is to be
     * loaded
     * @param type the {@link jaxp.sun.org.apache.bcel.internal.generic.Type} of the variable
     * @return the generated {@link LoadInstruction}
     */
    private static Instruction loadLocal(int index, jaxp.sun.org.apache.bcel.internal.generic.Type type) {
        if (type == jaxp.sun.org.apache.bcel.internal.generic.Type.BOOLEAN) {
           return new ILOAD(index);
        } else if (type == jaxp.sun.org.apache.bcel.internal.generic.Type.INT) {
           return new ILOAD(index);
        } else if (type == jaxp.sun.org.apache.bcel.internal.generic.Type.SHORT) {
           return new ILOAD(index);
        } else if (type == jaxp.sun.org.apache.bcel.internal.generic.Type.LONG) {
           return new LLOAD(index);
        } else if (type == jaxp.sun.org.apache.bcel.internal.generic.Type.BYTE) {
           return new ILOAD(index);
        } else if (type == jaxp.sun.org.apache.bcel.internal.generic.Type.CHAR) {
           return new ILOAD(index);
        } else if (type == jaxp.sun.org.apache.bcel.internal.generic.Type.FLOAT) {
           return new FLOAD(index);
        } else if (type == jaxp.sun.org.apache.bcel.internal.generic.Type.DOUBLE) {
    ...
    /**
     * Helper method to generate an instance of a subclass of
     * {@link StoreInstruction} based on the specified {@link jaxp.sun.org.apache.bcel.internal.generic.Type} that will
     ...
     */
    private static Instruction storeLocal(int index, jaxp.sun.org.apache.bcel.internal.generic.Type type) {
        if (type == jaxp.sun.org.apache.bcel.internal.generic.Type.BOOLEAN) {
    ...
    boolean widenConditionalBranchTargetOffsets() {
        ...
        for (InstructionHandle ih = il.getStart();
            ...
            switch (inst.getOpcode()) {
                ...
                case jaxp.sun.org.apache.bcel.internal.Constants.GOTO:
                case jaxp.sun.org.apache.bcel.internal.Constants.JSR:
                ...
                case jaxp.sun.org.apache.bcel.internal.Constants.TABLESWITCH:
                case jaxp.sun.org.apache.bcel.internal.Constants.LOOKUPSWITCH:
                ...
                case jaxp.sun.org.apache.bcel.internal.Constants.IF_ACMPEQ:
                case jaxp.sun.org.apache.bcel.internal.Constants.IF_ACMPNE:
                case jaxp.sun.org.apache.bcel.internal.Constants.IF_ICMPEQ:
                case jaxp.sun.org.apache.bcel.internal.Constants.IF_ICMPGE:
                case jaxp.sun.org.apache.bcel.internal.Constants.IF_ICMPGT:
                case jaxp.sun.org.apache.bcel.internal.Constants.IF_ICMPLE:
                case jaxp.sun.org.apache.bcel.internal.Constants.IF_ICMPLT:
                case jaxp.sun.org.apache.bcel.internal.Constants.IF_ICMPNE:
                case jaxp.sun.org.apache.bcel.internal.Constants.IFEQ:
                case jaxp.sun.org.apache.bcel.internal.Constants.IFGE:
                case jaxp.sun.org.apache.bcel.internal.Constants.IFGT:
                case jaxp.sun.org.apache.bcel.internal.Constants.IFLE:
                case jaxp.sun.org.apache.bcel.internal.Constants.IFLT:
                case jaxp.sun.org.apache.bcel.internal.Constants.IFNE:
                case jaxp.sun.org.apache.bcel.internal.Constants.IFNONNULL:
                case jaxp.sun.org.apache.bcel.internal.Constants.IFNULL:
        ...
        for (InstructionHandle ih = il.getStart();
            ...
            if (inst instanceof IfInstruction) {
                ...
                if ((relativeTargetOffset - maxOffsetChange
                    ...
                    // of the new IF
                    if (nextHandle == null) {
                        nextHandle = il.append(gotoHandle, InstructionConstants.NOP);
                    }
