 ...
 */
package jaxp.sun.org.apache.xalan.internal.xslt;
...
import jaxp.sun.org.apache.xalan.internal.Version;
...
/*
import jaxp.sun.org.apache.xalan.internal.trace.PrintTraceListener;
import jaxp.sun.org.apache.xalan.internal.trace.TraceManager;
import jaxp.sun.org.apache.xalan.internal.transformer.XalanProperties;
*/
  ...
  public static void _main(String argv[])
  {
    ...
    ResourceBundle resbundle =
      (SecuritySupport.getResourceBundle(
        XResourceBundle.ERROR_RESOURCES));
    String flavor = "s2s";
    ...
    else
    {
      ...
      if (useXSLTC)
      {
         ...
         String value = "jaxp.sun.org.apache.xalan.internal.xsltc.trax.TransformerFactoryImpl";
...
//          "XSL Process was not successful.");
      ...
      {
        while (throwable
               instanceof WrappedRuntimeException)
        {
          throwable =
            ((WrappedRuntimeException) throwable).getException();
        }
