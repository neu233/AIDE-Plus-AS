...
import jaxp.sun.org.apache.xerces.internal.impl.xs.util.ObjectListImpl;
...
import jaxp.sun.org.apache.xerces.internal.xs.XSWildcard;
...
public class SchemaGrammar implements XSGrammar, XSNamespaceItem {
    ...
    public static class BuiltinSchemaGrammar extends SchemaGrammar {
        ...
        private static final String EXTENDED_SCHEMA_FACTORY_CLASS = "jaxp.sun.org.apache.xerces.internal.impl.dv.xs.ExtendedSchemaDVFactoryImpl";
    ...
    private static class XSAnyType extends XSComplexTypeDecl {
        public XSAnyType () {
            ...
            fContentType = XSComplexTypeDefinition.CONTENTTYPE_MIXED;
