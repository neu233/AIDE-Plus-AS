...
import jaxp.sun.org.apache.xml.internal.dtm.ref.dom2dtm.DOM2DTM;
import jaxp.sun.org.apache.xml.internal.dtm.ref.dom2dtm.DOM2DTMdefaultNamespaceDeclarationNode;
import jaxp.sun.org.apache.xml.internal.dtm.ref.sax2dtm.SAX2DTM;
import jaxp.sun.org.apache.xml.internal.dtm.ref.sax2dtm.SAX2RTFDTM;
        ...
        try {
          ...
          **************************************************************/
          ...
          boolean haveXercesParser =
                     ...
                     && (reader.getClass()
                               .getName()
                               .equals("jaxp.sun.org.apache.xerces.internal.parsers.SAXParser") );
            ...
            if (haveXercesParser) {
              ...
              try {
                coParser =(IncrementalSAXSource)
                  Class.forName("jaxp.sun.org.apache.xml.internal.dtm.ref.IncrementalSAXSource_Xerces").newInstance();
              }  catch( Exception ex ) {
                ex.printStackTrace();
                coParser=null;
              }
