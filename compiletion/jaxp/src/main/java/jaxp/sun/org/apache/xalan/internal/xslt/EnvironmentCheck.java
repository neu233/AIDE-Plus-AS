 ...
 * <code>
 * java jaxp.sun.org.apache.xalan.internal.xslt.EnvironmentCheck [-out outFile]
 * </code></p>
 *
...
//              || "xalan.jar".equalsIgnoreCase(jarName))
  ...
  protected void checkProcessorVersion(Hashtable h)
  {
    ...
    try
    {
      final String XALAN1_VERSION_CLASS =
        "jaxp.sun.org.apache.xalan.internal.xslt.XSLProcessorVersion";
    ...
    try
    {
      ...
      final String XALAN2_VERSION_CLASS =
        "jaxp.sun.org.apache.xalan.internal.processor.XSLProcessorVersion";
    ...
    try
    {
      ...
      final String XALAN2_2_VERSION_CLASS =
        "jaxp.sun.org.apache.xalan.internal.Version";
  ...
  protected void checkParserVersion(Hashtable h)
  {
    ...
    try
    {
      final String XERCES1_VERSION_CLASS = "jaxp.sun.org.apache.xerces.internal.framework.Version";
    ...
    try
    {
      final String XERCES2_VERSION_CLASS = "jaxp.sun.org.apache.xerces.internal.impl.Version";
