...
import jaxp.sun.org.apache.xml.internal.serializer.Encodings;
...
final class Output extends TopLevelElement {
    ...
    public void parseContents(Parser parser) {
        ...
        if (_version.equals(EMPTYSTRING)) {
            _version = null;
        }
        else {
        ...
        if (_encoding.equals(EMPTYSTRING)) {
            _encoding = null;
        }
        else {
            try {
        ...
        if (_standalone.equals(EMPTYSTRING)) {
            _standalone = null;
        }
        else {
        ...
        if (_doctypeSystem.equals(EMPTYSTRING)) {
            _doctypeSystem = null;
        }
        else {
        ...
        if (_doctypePublic.equals(EMPTYSTRING)) {
            _doctypePublic = null;
        }
        else {
        ...
        if (_mediaType.equals(EMPTYSTRING)) {
            _mediaType = null;
        }
        else {
